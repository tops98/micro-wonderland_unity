...
public class SwitchService : MonoBehaviour
{
    ...
    public string serviceName = "switch_service";
    ...
    void Start()
    {
        ...
        ROSConnection.GetOrCreateInstance().ImplementService<SetStateRequest, SetStateResponse>(serviceName+"/set_state", SetState);
        ROSConnection.GetOrCreateInstance().ImplementService<GetAvailableStatesRequest, GetAvailableStatesResponse>(serviceName+"/get_available_states", GetAvailableStates);
        ROSConnection.GetOrCreateInstance().ImplementService<GetCurrentStateRequest, GetCurrentStateResponse>(serviceName+"/get_current_state", GetCurrentState);
    }
